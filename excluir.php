    ...
    if (isset($_GET["acao"]))
    {
        ...
        if ( $_GET["acao"] == "Excluir" )
        {
            ...
            if ($conexao)
            {
                ...
                $query = "delete from alunos where id_ = ".$id." ;"; //nome, matricula, id_ são os nomes dos campos no banco sql
...
<head>
    ...
    <title>Excluir Alunos | Curso Tech</title>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6 col-sm-12">
                ...
                <h3 class="tituloform">Excluir Alunos</h3>
                <br>
                            ...
                            <form action="#" method="GET">
                                ...
                                ?>
                                    <tr>
                                            ...
                                            <td>
                                                <input type="submit" name="acao" class="btn_editar" value="Excluir">
                                            </td>
                                    </tr>
